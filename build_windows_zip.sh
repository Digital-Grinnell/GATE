#!/usr/bin/env bash
# build_windows_zip.sh — Build a Windows distributable ZIP for GATE.
#
# Usage:
#   bash build_windows_zip.sh          # version defaults to 1.0
#   bash build_windows_zip.sh 1.2      # explicit version
#
# Output: GATE_v<version>_Windows.zip in the project root
#
...
echo
echo " Installation:"
echo "   1. Extract GATE_v${VERSION}_Windows.zip to a convenient folder"
...
echo "   • Leave the console window open while using GATE"
echo "────────────────────────────────────────────────"
