#!/usr/bin/env bash
# build_dmg.sh — Build a macOS distributable DMG for GATE.
#
# Usage:
#   bash build_dmg.sh          # version defaults to 1.0
#   bash build_dmg.sh 1.2      # explicit version
#
# Output: GATE_v<version>.dmg in the project root
#
...
VERSION="${1:-1.0}"
APP_NAME="GATE"
BUNDLE_ID="com.template.gate"
DISPLAY_NAME="GATE — GCCB Alma Transfer Environment"
...
# ── 2. Launcher script (Contents/MacOS/GATE) ───────────────────────────────
...
echo "   2. Drag GATE.app to your Applications folder (or any convenient location)"
echo "   3. Eject the DMG"
echo
echo " First launch (Gatekeeper — unsigned app):"
echo "   • Right-click GATE.app → Open → click Open in the dialog"
...
echo "   • The GATE window opens when setup is complete"
