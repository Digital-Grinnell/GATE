@echo off
REM GATE - GCCB Alma Transfer Environment - Windows Launch Script
...
echo === GATE - GCCB Alma Transfer Environment ===
echo.
...
if errorlevel 1 (
    echo.
    echo GATE exited with an error. See messages above.
    pause
)
